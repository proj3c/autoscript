...
TIME="10"
CHATID="6256307021"
KEY="7077823927:AAGwDpiQqPI6O8cXyNvhhrDT5kDRSvePx90"
...
data_ip="https://raw.githubusercontent.com/proj3c/regip/main/ip"
checking_sc() {
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/proj3c/regip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/proj3c/regip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/proj3c/regip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/proj3c/autoscript/main/"
...
function notif_bot() {
    USRSC=$(curl https://raw.githubusercontent.com/proj3c/regip/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/proj3c/regip/main/ip | grep $ipsaya | awk '{print $3}')
...
clear
# // Installing UDP Mini
print_install "Memasang SlowDNS Server"
    wget ${REPO}slowdns/ns.sh && chmod +x ns.sh && ./ns.sh
